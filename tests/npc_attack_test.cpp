...
static void test_melee_attacks( const npc_attack_melee_test_data &data )
{
    ...
    clear_vehicles();
    g->weather.weather_override = weather_type_id( "sunny" );
    ...
    npc_attack_effectiveness wep_effectiveness = wep.evaluate( main_npc, zomble );
    // base effectiveness against the zombie
    ...
    // even if the distant target is the npc's ctual target,
...
static void test_reach_attacks( const npc_attack_melee_test_data &data )
{
    ...
    npc_attack_effectiveness wep_effectiveness = wep.evaluate( main_npc, mon_far );
...
static void test_gun_attacks( const npc_attack_gun_test_data &data )
{
    ...
    npc_attack_effectiveness gun_effectiveness = gun_default.evaluate( main_npc, near_zombie );
