...
class npc_attack_effectiveness
{
        ...
        tripoint _target;
    public:
        npc_attack_effectiveness() = default;
        npc_attack_effectiveness( const cata::optional<int> &_value,
        ...
        bool operator>( const npc_attack_effectiveness &rhs ) const;
        bool operator>( int rhs ) const;
        bool operator<( int rhs ) const;
        npc_attack_effectiveness operator-=( int rhs );
};
...
class npc_attack
{
    public:
         ...
         */
        virtual npc_attack_effectiveness evaluate( const npc &source, const Creature *target ) const = 0;
         ...
         */
        virtual std::vector<npc_attack_effectiveness> all_evaluations( const npc &source,
...
class npc_attack_melee : public npc_attack
{
    ...
    public:
        ...
        npc_attack_effectiveness evaluate( const npc &source, const Creature *target ) const override;
        std::vector<npc_attack_effectiveness> all_evaluations( const npc &source,
    ...
    private:
        ...
        npc_attack_effectiveness evaluate_critter( const npc &source, const Creature *target,
...
class npc_attack_gun : public npc_attack
{
    ...
    private:
        ...
        bool can_use( const npc &source ) const;
        int base_time_penalty( const npc &source ) const;
        npc_attack_effectiveness evaluate_tripoint(
