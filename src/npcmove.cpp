    ...
    */
    ...
    switch( action ) {
        case npc_do_attack:
            ...
            ai_cache.current_attack_evaluation = npc_attack_effectiveness{};
            break;
        case npc_pause:
            move_pause();
            break;
...
void npc::evaluate_best_weapon( const Creature *target )
{
    ...
    npc_attack_effectiveness best_evaluated_attack;
    const auto compare = [&best_attack, &best_evaluated_attack, this, &target]
    ( const std::shared_ptr<npc_attack> &potential_attack ) {
        const npc_attack_effectiveness evaluated = potential_attack->evaluate( *this, target );
